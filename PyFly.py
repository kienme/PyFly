...
walls = [[cat_y + wall_gap, 10], [cat_y + wall_gap * 2, 20],
         [cat_y + wall_gap * 3, 30], [cat_y + wall_gap * 4, 40]]
for i in range(0, 4):
...
while run_game:
    ...
    for i in range(0, 4):
        ...
        if pygame.Rect(cat).colliderect(
                rect1) or pygame.Rect(cat).colliderect(rect2):
            cat_color = (0, 255, 0)
